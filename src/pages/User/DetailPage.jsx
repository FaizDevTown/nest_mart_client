            ...
            <div className="row related-products">
              <div className="col-lg-3 col-md-4 col-12 col-sm-6">
                <div className="product-cart-wrap hover-up">
                  ...
                  <div className="product-content-wrap">
                    <h2><div tabIndex={0}>Ulstra Bass Headphone</div></h2>
              ...
              <div className="col-lg-3 col-md-4 col-12 col-sm-6">
                <div className="product-cart-wrap hover-up">
                  ...
                  <div className="product-content-wrap">
                    <h2><div tabIndex={0}>Smart Bluetooth Speaker</div></h2>
                    <div className="rating-result" title="90%">
                      <span> </span>
                    </div>
                    <div className="product-price">
              ...
              <div className="col-lg-3 col-md-4 col-12 col-sm-6">
                <div className="product-cart-wrap hover-up">
                  ...
                  <div className="product-content-wrap">
                    <h2><div tabIndex={0}>HomeSpeak 12UEA Goole</div></h2>
                    <div className="rating-result" title="90%">
                      <span> </span>
                    </div>
                    <div className="product-price">
              ...
              <div className="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
                <div className="product-cart-wrap hover-up mb-0">
                  ...
                  <div className="product-content-wrap">
                    <h2><div tabIndex={0}>Dadua Camera 4K 2022EF</div></h2>
                    <div className="rating-result" title="90%">
                      <span> </span>
                    </div>
                    <div className="product-price">
